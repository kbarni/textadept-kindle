...
void ScintillaGTK::Finalise() {
	...
	if (accessible) {
		//**** (GTK_ACCESSIBLE(accessible), nullptr);
...
gboolean ScintillaGTK::DragMotionThis(GdkDragContext *context,
	...
	try {
		...
		GdkDragAction preferredAction = static_cast<GdkDragAction>(0);//**** gdk_drag_context_get_suggested_action(context);
		const GdkDragAction actions = static_cast<GdkDragAction>(0);//**** gdk_drag_context_get_actions(context);
...
void ScintillaGTK::DragDataGet(GtkWidget *widget, GdkDragContext *context,
	...
	try {
		...
		const GdkDragAction action = static_cast<GdkDragAction>(0);//**** gdk_drag_context_get_selected_action(context);
