...
-- Predefined styles.
styles[view.STYLE_DEFAULT] = {fore = colors.black, back = colors.white}
styles[view.STYLE_LINENUMBER] = {fore = colors.black, back=colors.white, bold = true}
...
styles[view.STYLE_CALLTIP] = {fore = colors.black, back = colors.white}
...
-- styles[lexer.BOLD] = {}
styles[lexer.CLASS] = {fore = colors.blue, bold = true}
-- styles[lexer.CODE] = {}
...
styles[lexer.VARIABLE_BUILTIN] = {fore = colors.blue, bold = true}
...
view.marker_fore[view.MARKNUM_HISTORY_MODIFIED] = colors.blue
view.marker_fore[view.MARKNUM_HISTORY_SAVED] = colors.green
view.marker_fore[view.MARKNUM_HISTORY_REVERTED_TO_MODIFIED] = colors.blue
view.marker_fore[view.MARKNUM_HISTORY_REVERTED_TO_ORIGIN] = colors.blue
